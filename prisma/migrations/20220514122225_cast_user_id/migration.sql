...
INSERT INTO "new_users" ("created_at", "email", "email_verified", "id", "image", "name", "updated_at", "user_id") SELECT "created_at", "email", "email_verified", "id", "image", "name", "updated_at", "user_id" FROM "users";
DROP TABLE "users";
